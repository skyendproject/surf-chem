      ...
      <table className="w-full border-collapse border-2 border-[#CCCCCC]">
        <thead className="border-2 border-[#CCCCCC]">
          <tr className="bg-tableColor border-2 border-[#CCCCCC] text-black2 text-[18px]">
            <th className="border-2 border-[#CCCCCC] px-0 py-0 text-left font-bold max-w-[180px] whitespace-normal break-words">
              PRODUCT NAME
            </th>

            <th className="border-2 border-[#CCCCCC] px-0 py-0 text-left font-bold max-w-[150px] whitespace-normal break-words">
              SURFACTANT SERIES
            </th>

            <th className="border-2 border-[#CCCCCC] px-0 py-0 text-left font-bold max-w-[160px] whitespace-normal break-words">
              CHEMICAL CATEGORY
            </th>

            <th
              className="border-2 border-[#CCCCCC] px-0 py-0 text-center font-bold"
          ...
          <tr className="bg-white text-[18px]">
            <th className="border-2 border-[#CCCCCC] px-0 py-0 w-0 whitespace-nowrap"></th>
            <th className="border-2 border-[#CCCCCC] px-0 py-0 w-0 whitespace-nowrap"></th>
            <th className="border-2 border-[#CCCCCC] px-0 py-0 w-0 whitespace-nowrap"></th>
            {formulationTypes.map((type) => (
              <th
                key={type}
                className="border-2 border-[#CCCCCC] px-0 py-0 text-center font-bold text-black2 min-w-[40px]"
              >
                {type}
              </th>
            ))}
